...
// Static fallback: 118 elements in order (never changes, no API needed)
const ELEMENTS_STATIC = [
...
].map(([n, s]) => ({ AtomicNumber: n, Symbol: s }))

const state = reactive({
  elements: ELEMENTS_STATIC,  // pre-populated; enriched later when API responds
  loaded: false
})
